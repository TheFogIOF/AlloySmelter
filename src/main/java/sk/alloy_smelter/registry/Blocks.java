...
public class Blocks {
    ...
    public static final RegistryObject<Block> FORGE_CONTROLLER = registerBlock("forge_controller",
() -> new ForgeControllerBlock(BlockBehaviour.Properties.copy(net.minecraft.world.level.block.Blocks.BLACKSTONE)));
