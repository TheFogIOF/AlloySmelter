...
public class SmeltingRecipeCategory implements IRecipeCategory<SmeltingRecipe> {
    public static final ResourceLocation UID = new ResourceLocation(AlloySmelter.MOD_ID, "smelting");
    public static final ResourceLocation TEXTURE = new ResourceLocation(AlloySmelter.MOD_ID,
