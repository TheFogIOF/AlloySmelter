...
public class JEICategorySmeltingT2 implements IRecipeCategory<SmeltingRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(AlloySmelter.MOD_ID, "smelting_tier2");
    ...
    public JEICategorySmeltingT2(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(Blocks.FORGE_CONTROLLER_TIER2.get()));
