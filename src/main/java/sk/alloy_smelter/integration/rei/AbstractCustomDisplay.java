...
public abstract class AbstractCustomDisplay extends BasicDisplay {
    ...
    public AbstractCustomDisplay(List<EntryIngredient> input, List<EntryIngredient> output, Optional<ResourceLocation> id, CompoundTag tag) {
        this(input, output, id, tag.getInt("smeltingTime"), tag.getInt("fuelPerTick"));
    }
    ...
    public AbstractCustomDisplay(List<EntryIngredient> input, List<EntryIngredient> output, Optional<ResourceLocation> location, int smeltingTime, int fuelPerTick) {
    ...
    protected interface Constructor<T extends AbstractCustomDisplay> {
        T create(List<EntryIngredient> inputs, List<EntryIngredient> outputs, Optional<ResourceLocation> location, int smeltingTime, int fuelPerTick);
    }
}
