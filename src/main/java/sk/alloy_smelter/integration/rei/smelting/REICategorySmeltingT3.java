...
public class REICategorySmeltingT3 implements DisplayCategory<DisplaySmeltingT3> {
    ...
    public Renderer getIcon() {
        return EntryStacks.of(Blocks.FORGE_CONTROLLER_TIER3.get());
    }

    @Override
    public List<Widget> setupDisplay(DisplaySmeltingT3 display, Rectangle bounds) {
    ...
    @Override
    public int getDisplayWidth(DisplaySmeltingT3 smeltingDisplay) {
        return 184;
    }
