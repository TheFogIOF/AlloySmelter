...
public class REICategorySmeltingT1 implements DisplayCategory<DisplaySmeltingT1> {
    ...
    public static final CategoryIdentifier<DisplaySmeltingT1> SMELTING_RECIPE_TYPE =
            CategoryIdentifier.of(AlloySmelter.MOD_ID, "smelting_tier1");

    @Override
    public CategoryIdentifier<? extends DisplaySmeltingT1> getCategoryIdentifier() {
    ...
    public Renderer getIcon() {
        return EntryStacks.of(Blocks.FORGE_CONTROLLER_TIER1.get());
    }

    @Override
    public List<Widget> setupDisplay(DisplaySmeltingT1 display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createDrawableWidget((graphics, mouseX, mouseY, delta) -> {
            ...
            graphics.blit(RenderType::guiTextured, TEXTURE, startPoint.x + 44, startPoint.y + 47 + 12 - height, 179, 1 + (12 - height), 9, height, 256, 256);
        }));

        widgets.add(Widgets.createDrawableWidget((graphics, mouseX, mouseY, delta) -> {
            int width = Mth.ceil((System.currentTimeMillis() / (3200 / 22) % 22d));
            graphics.blit(RenderType::guiTextured, TEXTURE, startPoint.x + 84, startPoint.y + 35, 177, 14, width, 16, 256, 256);
        }));
    ...
    @Override
    public int getDisplayWidth(DisplaySmeltingT1 smeltingDisplay) {
        return 184;
    }
